...
MoveEnd:
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, FIGHTING, 100, 25		;Normal -> Fighting
	...
	move RAZOR_WIND,   NO_ADDITIONAL_EFFECT,        80, FLYING,   100, 10		;Strikes immediately, 80 POW, 100 ACC, Normal -> Flying
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,   100, 10		;10 PP
	...
	move HORN_ATTACK,  POISON_SIDE_EFFECT1,         65, POISON,   100, 15		;20% chance to Poison, Normal -> Poison, 15 PP
	...
	move STRENGTH,     NO_ADDITIONAL_EFFECT,       100, NORMAL,   100,  5		;100 POW, 5 PP
	move ABSORB,       DRAIN_HP_EFFECT,             40, GRASS,    100, 10		;40 POW, 10 PP
	move MEGA_DRAIN,   DRAIN_HP_EFFECT,             60, GRASS,    100,  5		;60 POW, 5 PP
	...
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             40, BUG,      100, 10		;40 POW, 10 PP
	...
	move TRI_ATTACK,   SWIFT_EFFECT,                80, NORMAL,   100, 10		;Swift effect
