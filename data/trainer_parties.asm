...
; Victory Road 4
	db 97,MAGCARGO,DITTO,MAGNETON,WEEZING,PORYGON2,GENGAR,0					;NEW				;Custom Moves Applied
	db 97,MUK,GLIGAR,ELECTRODE,DITTO,JUMPLUFF,STARMIE,0						;NEW				;Custom Moves Applied
; Unused
...
; Mansion 2F
	db 87,CHARIZARD,WEEZING,RAPIDASH,MAGCARGO,AERODACTYL,TENTACRUEL,0		;Custom Moves Applied
; Mansion 3F
	db 87,MAGCARGO,ARBOK,ARCANINE,CHARIZARD,HITMONCHAN,VICTREEBEL,0			;Custom Moves Applied
; Mansion B1F
	db 87,FLAREON,VICTREEBEL,NINETALES,TENTACRUEL,CHARIZARD,GYARADOS,0		;Custom Moves Applied
; Pokemon Tower 6F
...
; Victory Road 4
	db 99,POLITOED,DUGTRIO,RAPIDASH,AMPHAROS,KABUTOPS,CROBAT,0				;NEW	;Custom Moves Applied
FisherData:
; SS Anne 2F Rooms
...
; Route 21
	db 88,SEAKING,DEWGONG,CORSOLA,QUAGSIRE,SEADRA,GOLDUCK,0					;Custom Moves Applied
	db 88,SEADRA,GOLDUCK,CLOYSTER,QWILFISH,SLOWBRO,KINGLER,0				;Custom Moves Applied
	db 88,GYARADOS,GYARADOS,GYARADOS,GYARADOS,GYARADOS,GYARADOS,0
	db 91,POLITOED,BLASTOISE,STARMIE,0										;Custom Moves Applied
; Route 12
...
; Route 21
	db 89,CLOYSTER,TENTACRUEL,QWILFISH,SLOWBRO,BLASTOISE,0					;Custom Moves Applied
	db 90,KABUTOPS,KINGLER,POLIWRATH,STARMIE,0								;Custom Moves Applied
	db 90,OMASTAR,TENTACRUEL,STARMIE,POLIWRATH,0							;Custom Moves Applied
	db 92,DRAGONAIR,DRAGONAIR,0												;Custom Moves Applied
CueBallData:
; Route 16
...
; Route 21
	db 88,MAGIKARP,0														;Custom Moves Applied
; Route 2
...
; Silph Co. 10F
	db 71,DITTO,0
; Mansion 3F
	db 87,DITTO,MUK,ELECTRODE,TANGELA,MAGNETON,LICKILICKI,0						;Custom Moves Applied
; Mansion B1F
	db 87,ALAKAZAM,DITTO,ALAKAZAM,DITTO,ALAKAZAM,DITTO,0						;Custom Moves Applied
; Unused/joenote - restored and put in Mansion 1F
	db 87,DITTO,WEEZING,MAGNETON,EXEGGUTOR,ELECTRODE,PORYGON2,0					;Custom Moves Applied
; Rocket Hideout B2F
...
; Viridian Gym
	db $FF,93,KANGASKHAN,93,DUGTRIO,94,GOLEM,94,NIDOKING,95,DONPHAN,95,ARM_MEWTWO,0	;Custom Moves Applied												;Custom Moves Applied
RocketData:
; Mt. Moon B2F
...
; Victory Road 3F
	db 97,GOLDUCK,EXEGGUTOR,FLAREON,KINGLER,DUGTRIO,TAUROS,0							;Custom Moves Applied
	db 97,BUTTERFREE,NIDOKING,ARCANINE,PILOSWINE,TENTACRUEL,DODRIO,0
; Victory Road 1F
...
; Victory Road 3F
	db 97,VICTREEBEL,NIDOQUEEN,STARMIE,CLEFABLE,VAPOREON,CHANSEY,0						;Custom Moves Applied
	db 97,BEEDRILL,RAICHU,QWILFISH,ALAKAZAM,DONPHAN,PIDGEOT,0							;Custom Moves Applied
; Victory Road 1F
...
BrunoData:
	db 1,DIMONIX,MACHAMP,HERACROSS,KANGASKHAN,HITMONCHAN,HITMONLEE,0					;Custom Moves Applied
BrockData:
...
; Route 22
	db $FF,95,DODRIO,95,HYPNO,96,SANDSLASH,96,SNORLAX,97,FLAREON,97,BLASTOISE,0			;Custom Moves Applied
	db $FF,95,DODRIO,95,HYPNO,96,SANDSLASH,96,SNORLAX,97,VAPOREON,97,VENUSAUR,0			;Custom Moves Applied
	db $FF,95,DODRIO,95,HYPNO,96,SANDSLASH,96,SNORLAX,97,JOLTEON,97,CHARIZARD,0			;Custom Moves Applied
Green3Data:
	db 1,NIDOKING,ARCANINE,LEAFEON,AERODACTYL,BLASTOISE,MEWTWO,0						;Custom Moves Applied
	db 1,NIDOKING,ARCANINE,LEAFEON,AERODACTYL,VENUSAUR,MEWTWO,0						;Custom Moves Applied
	db 1,NIDOKING,ARCANINE,LEAFEON,AERODACTYL,CHARIZARD,MEWTWO,0						;Custom Moves Applied
LoreleiData:
	db 1,JYNX,SLOWBRO,PORYGON2,LAPRAS,CHANSEY,ARTICUNO,0								;Custom Moves Applied
ChannelerData:
; Pokémon Tower 3F
...
; Unused
	...
	;db 24,GASTLY,0
AgathaData:
	db 1,CROBAT,ALAKAZAM,MISDREAVUS,TENTACRUEL,HOUNDOOM,GENGAR,0						;Custom Moves Applied
LanceData:
	db 1,DRAGONITE,GYARADOS,DRAGONITE,KINGDRA,DRAGONITE,LUGIA,0						;Custom Moves Applied
BugMasterData:	;NEW
; Viridian Forest
	db 12,METAPOD,PINSIR,0																;Custom Moves Applied
; Mansion B1F
	db 89,VENOMOTH,SCIZOR,VENUSAUR,PINSIR,JUMPLUFF,HERACROSS,0		;NEW				;Custom Moves Applied
