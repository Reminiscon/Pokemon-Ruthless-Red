LavenderTownObject:
	...
	warp 11, 13, 0, LAVENDER_HOUSE_1
	warp 15, 13, 0, LAVENDER_MART
	warp  1, 11, 0, LAVENDER_HOUSE_2
	warp  5, 11, 0, NAME_RATERS_HOUSE
	...
	sign  9, 13, 8 ; LavenderTownText8
	sign 17, 7, 9 ; LavenderTownText9

	db 3 ; objects
	object SPRITE_LITTLE_GIRL, 15, 9, WALK, 0, 1 ; person
	object SPRITE_BLACK_HAIR_BOY_1,  6, 13, STAY, NONE, 2 ; person
	...
	warp_to 11, 13, LAVENDER_TOWN_WIDTH ; LAVENDER_HOUSE_1
	warp_to 15, 13, LAVENDER_TOWN_WIDTH ; LAVENDER_MART
	warp_to  1, 11, LAVENDER_TOWN_WIDTH ; LAVENDER_HOUSE_2
	warp_to  5, 11, LAVENDER_TOWN_WIDTH ; NAME_RATERS_HOUSE
