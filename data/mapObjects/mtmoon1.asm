MtMoon1Object:
	...
	db 13 ; objects
	object SPRITE_HIKER,  5,  6, STAY, RIGHT, 1, OPP_HIKER, 1
	object SPRITE_BUG_CATCHER, 13, 16, STAY, RIGHT, 2, OPP_YOUNGSTER, 3
	object SPRITE_LASS, 30, 4, STAY, DOWN, 3, OPP_LASS, 5
	object SPRITE_BLACK_HAIR_BOY_2,  7, 30, STAY, LEFT, 4, OPP_SUPER_NERD, 1
	...
	object SPRITE_BALL,  2, 20, STAY, NONE, 8, SUPER_POTION
	object SPRITE_BALL, 36, 23, STAY, NONE, 9, MOON_STONE
	object SPRITE_BALL, 35, 31, STAY, NONE, 10, RARE_CANDY
	object SPRITE_BALL,  2,  2, STAY, NONE, 11, ESCAPE_ROPE
	object SPRITE_BALL, 20, 33, STAY, NONE, 12, SUPER_POTION
	object SPRITE_BALL, 5, 32, STAY, NONE, 13, TM_12

	; warp-to
	warp_to 14, 35, MT_MOON_1_WIDTH
	warp_to 15, 35, MT_MOON_1_WIDTH
	warp_to  7,  5, MT_MOON_1_WIDTH ; MT_MOON_2
