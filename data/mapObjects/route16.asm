Route16Object:
	...
	db 2 ; signs
	sign 27, 11, 9 ; Route16Text9
	sign 27, 15, 10 ; Route16Text10

	db 8 ; objects
	object SPRITE_BIKER, 11, 12, STAY, UP, 1, OPP_BIKER, 5
	object SPRITE_BIKER, 12, 11, STAY, RIGHT, 2, OPP_CUE_BALL, 1
	object SPRITE_BIKER,  8, 11, STAY, RIGHT, 3, OPP_CUE_BALL, 2
	object SPRITE_BIKER,  7, 12, STAY, UP, 4, OPP_BIKER, 6
	object SPRITE_BIKER,  4, 11, STAY, RIGHT, 5, OPP_CUE_BALL, 3
	object SPRITE_BIKER,  8, 14, STAY, RIGHT, 6, OPP_BIKER, 7
