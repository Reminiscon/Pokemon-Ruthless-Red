PowerPlantObject:
	...
	object SPRITE_BALL,  7, 25, STAY, NONE, 10, ULTRA_BALL
	object SPRITE_BALL, 28, 3, STAY, NONE, 11, X_SPECIAL
	object SPRITE_BALL, 34, 3, STAY, NONE, 12, FULL_RESTORE
	object SPRITE_BALL, 26, 32, STAY, NONE, 13, TM_25
	object SPRITE_BALL, 20, 32, STAY, NONE, 14, TM_33

	; warp-to
	warp_to  4, 34, POWER_PLANT_WIDTH
	warp_to  5, 34, POWER_PLANT_WIDTH
	warp_to  0,  3, POWER_PLANT_WIDTH
