SilphCo10Object:
	...
	warp  3, 11, 5, SILPH_CO_4F
	warp 13, 7, 6, SILPH_CO_4F
	warp  5,  5, 8, SILPH_CO_9F
	warp 10,  9, 28, SILPH_CO_1F ; ONE-WAY WARP

	db 0 ; signs

	db 6 ; objects
	object SPRITE_ROCKET,  1,  9, STAY, RIGHT, 1, OPP_ROCKET, 38
	object SPRITE_OAK_AIDE,  7,  9, STAY, RIGHT, 2, OPP_SCIENTIST, 10
	object SPRITE_ERIKA, 9, 15, WALK, 0, 3 ; person
	object SPRITE_BALL, 2, 12, STAY, NONE, 4, TM_17
	object SPRITE_BALL, 4, 14, STAY, NONE, 5, RARE_CANDY
	object SPRITE_BALL, 5, 11, STAY, NONE, 6, ELIXER
	...
	warp_to  3, 11, SILPH_CO_10F_WIDTH ; SILPH_CO_4F
	warp_to 13, 7, SILPH_CO_10F_WIDTH ; SILPH_CO_4F
	warp_to  5,  5, SILPH_CO_10F_WIDTH ; SILPH_CO_9F
	warp_to 10,  9, SILPH_CO_10F_WIDTH ; SILPH_CO_1F (ONE-WAY WARP)
