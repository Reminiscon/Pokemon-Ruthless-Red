UnknownDungeon3Object:
	...
	db 3 ; objects
IF DEF(_GREEN)
	object SPRITE_SLOWBRO, 5, 10, STAY, DOWN, 1, MEWTWO, 100
	object SPRITE_BALL, 24,  7, STAY, NONE, 2, ULTRA_BALL
	object SPRITE_BALL, 24,  1, STAY, NONE, 3, MAX_ELIXER
ELSE
	object SPRITE_SLOWBRO, 27, 13, STAY, DOWN, 1, MEWTWO, 100
	object SPRITE_BALL, 16, 9, STAY, NONE, 2, ULTRA_BALL
	object SPRITE_BALL, 18, 1, STAY, NONE, 3, MAX_ELIXER
ENDC
