...
MapHSC9:
	...
	db ROCKET_HIDEOUT_3,$05,Show
MapHSCA:
	db ROCKET_HIDEOUT_4,$01,Show
	db ROCKET_HIDEOUT_4,$08,Show
	db ROCKET_HIDEOUT_4,$09,Show
	db ROCKET_HIDEOUT_4,$0A,Show
